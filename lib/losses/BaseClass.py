# /*
#  * @Author: anonymous 
#  * @Date: 2021-01-13 22:56:40 
#  * @Last Modified by:   anonymous 
#  * @Last Modified time: 2021-01-13 22:56:40 
#  */
import torch
from torch import nn as nn
import sys, os
sys.path.append('/home/zongdaoming/cv/multi-organ/multi-organ-ijcai')
from lib.losses.basic import expand_as_one_hot


class _AbstractDiceLoss(nn.Module):
    """
    Codes are adapted and mofified from https://github.com/wolny/pytorch-3dunet/blob/master/pytorch3dunet/unet3d/losses.py
