...
class ResNetMed3D(BaseModel):
    ...
    def test(self, device = 'cpu'):
        ...
        summary(self.to(device), (self.in_channels, 16, 16, 16), device = 'cpu')
        print("ResNetMed3D test is completed!")
...
if __name__ == "__main__":
    """Input channels must be 2 or 3.
    """
    model = generate_resnet3d(in_channels=2)
    model.test()
