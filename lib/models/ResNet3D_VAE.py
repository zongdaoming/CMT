...
class GreenBlock(nn.Module):
    ...
    def __init__(self, in_channels=2, out_channels=32, norm="group"):
...
class ResNet3dVAE(BaseModel):
    ...
    def test(self, device='cpu'):
        ...
        summary(self.to(device), (self.modalities, self.dim[0], self.dim[1], self.dim[2]), device='cpu')
