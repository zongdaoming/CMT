...
def get_destination(i):
    destination = Path("__file__").parent.parent /\
        "/home/zongdaoming/cv/multi-organ/KiTS/kits19/data" / "case_{:05d}".format(i) / "imaging.nii.gz"
    if not destination.parent.exists():
        destination.parent.mkdir()
        # PosixPath('/home/zongdaoming/cv/multi-organ/KiTS/kits19/data/case_00000')
    return destination
