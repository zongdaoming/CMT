# /*
#  * @Author: dorming
#  * @Date: 2021-01-14 16:38:41
#  * @Last Modified by:   dorming
#  * @Last Modified time: 2021-01-14 16:38:41
#  */
import os
import numpy as np
...
class TensorboardWriter:
    def __init__(self, args):
        name_model = args.log_dir + args.model + \
            "_" + args.dataset_name + "_" + datestr()
        # define torch.utils.tensorboard summarywriter
        self.writer = SummaryWriter(
            log_dir=args.log_dir + name_model, comment=name_model)
        make_dirs(args.save)
